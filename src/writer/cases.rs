...
#[async_trait(?Send)]
impl<W, L, R, F> Writer<W> for Cases<L, R, F>
where
    W: World,
    L: Writer<W>,
    R: Writer<W>,
...
#[async_trait(?Send)]
impl<'val, W, L, R, Val, F> writer::Arbitrary<'val, W, Val> for Cases<L, R, F>
where
    W: World,
...
impl<W, L, R, F> writer::Failure<W> for Cases<L, R, F>
where
    L: writer::Failure<W>,
    R: writer::Failure<W>,
    F: FnMut(
...
impl<L, R, F> writer::Normalized for Cases<L, R, F>
where
    L: writer::Normalized,
    R: writer::Normalized,
{
...
impl<L, R, F> writer::NonTransforming for Cases<L, R, F>
where
