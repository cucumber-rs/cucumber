//! Common [`Future`]s definitions.

use std::{future::Future, pin::Pin, task};

/// Wakes the current task and returns [`task::Poll::Pending`] once.
///
/// This function is useful when we want to cooperatively give time to the task
/// scheduler. It is generally a good idea to yield inside loops because that
