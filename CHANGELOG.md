...
- Made step argument of functions, marked with attribute, `Step` instead of `StepContext` again, while callbacks still receive `StepContext` as a second parameter ([#128])
